...
public class TestMainWindow
{
    ...
    public void TestConstructor()
    {
        ...
        MainWindow mainWindowViewModel = new(rservice, new AnalysisQueueStub(), Mock.Of<Configuration>());
    ...
    public void TestHandleAnalysisQueueCountChangedMessage()
    {
        ...
        MainWindow mainWindowViewModel = new(new RserviceStub(), new AnalysisQueueStub(), Mock.Of<Configuration>())
        {
            Analyses = [
    ...
    public void TestStartAnalysis()
    {
        ...
        MainWindow mainWindowViewModel = new(rservice, new AnalysisQueue(rservice), Mock.Of<Configuration>());
    ...
    public void TestAnalysisWithDifferentWeights()
    {
        ...
        configurationMock.Setup(conf => conf.GetVirtualVariablesFor(It.IsAny<string>(), It.IsAny<DatasetType>())).Returns([]);
        ...
        Policy.Handle<NotNullException>().WaitAndRetry(50, _ => TimeSpan.FromMilliseconds(100))
        ...
        Policy.Handle<NotEmptyException>().WaitAndRetry(50, _ => TimeSpan.FromMilliseconds(100))
        ...
        Policy.Handle<EqualException>().WaitAndRetry(50, _ => TimeSpan.FromMilliseconds(100))
    ...
    public void TestReloadCurrentDatasetCommand()
    {
        ...
        mainWindowViewModel.AnalysisConfiguration = analysisConfiguration;
