...
public class TestConfiguration
{
    ...
    public void TestGetStoredRecentSubsettingExpressions()
    {
        ...
        SystemSettings systemSettings = new(new Mock<Rservice>().Object, configuration, new Mock<Logging>().Object, new DatasetTypeRepositoryStub(), new SettingsServiceStub(), new AnalysisQueueStub());
